...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('full_name', models.CharField(max_length=200, unique=True, verbose_name='contributor full name')),
            ],
        ),
        migrations.CreateModel(
            name='Country',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avg_vote', models.IntegerField(verbose_name='average user vote')),
                ('imdb_score', models.IntegerField(verbose_name='movie imdb score')),
                ('metascore', models.IntegerField(null=True, verbose_name='movie metascore')),
                ...
                ('reviews_from_critics', models.IntegerField(null=True, verbose_name='number of reviews from users')),
                ('image_url', models.URLField(blank=True, null=True, verbose_name='poster image url')),
                ('url', models.URLField(verbose_name='movie imdb url')),
            ],
        ),
        migrations.CreateModel(
            name='Rating',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contributor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.contributor')),
